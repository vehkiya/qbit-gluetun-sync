...
- Exposes useful endpoints like `/healthz` for Kubernetes probes.
...
- `GET /healthz` - Returns `200 OK` if the sidecar is running. Useful for Docker health checks and Kubernetes probes.
